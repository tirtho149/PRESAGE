...
from .loss import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss, DualProjectorClipLoss
...
def create_loss(args):
    ...
    elif hasattr(args, 'dual_projector') and args.dual_projector:
        return DualProjectorClipLoss(
            local_loss=args.local_loss,
            gather_with_grad=args.gather_with_grad,
            cache_labels=True,
            rank=args.rank,
