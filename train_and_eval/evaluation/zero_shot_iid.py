...
from open_clip_train.imagenet_zeroshot_data import openai_imagenet_template
    ...
    with torch.no_grad():
        ...
        for images, target in tqdm(dataloader, unit_scale=args.batch_size):
            ...
            with autocast():
                ...
                # Handle both single and dual projector modes
                if isinstance(image_features, tuple):
                    image_features = image_features[0]  # Use first feature (taxonomic)
