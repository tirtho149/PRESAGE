...
#SBATCH --output=/work/mech-ai/tirtho/ObservePlantSwarm/logs/phase1_plantswarm-%j.out
#SBATCH --error=/work/mech-ai/tirtho/ObservePlantSwarm/logs/phase1_plantswarm-%j.err
