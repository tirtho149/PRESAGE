...
#SBATCH --output=/work/mech-ai-scratch/tirtho/PlantSwarm/logs/phase2_experiments-%j.out
#SBATCH --error=/work/mech-ai-scratch/tirtho/PlantSwarm/logs/phase2_experiments-%j.err
