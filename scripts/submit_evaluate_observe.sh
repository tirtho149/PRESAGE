...
#SBATCH --output=/work/mech-ai-scratch/tirtho/PlantSwarm/logs/evaluate_observe-%j.out
#SBATCH --error=/work/mech-ai-scratch/tirtho/PlantSwarm/logs/evaluate_observe-%j.err
