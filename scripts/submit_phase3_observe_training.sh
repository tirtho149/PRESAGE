...
#SBATCH --output=/work/mech-ai-scratch/tirtho/PlantSwarm/logs/phase3_observe_training-%j.out
#SBATCH --error=/work/mech-ai-scratch/tirtho/PlantSwarm/logs/phase3_observe_training-%j.err
